const colors = [
  "beige","brown","dkgrey","lime","ltgrey", "orange",
  "pink","purple","red","royal","teal","yellow"
];
...
function fitStage() {
  ...
  const scale = Math.min(viewportWidth / stageWidth, viewportHeight / stageHeight, 1);
